...
# add to GIT_SRC as repo:user
# this translates to git@github.com/user/repo.git
# user will default to openwebos is not specified
GIT_SRC="
...
#    fi
    if [ ! -d $BASE/luna-sysmgr ] ; then
    	git clone git@github.com:phoenix0428/luna-sysmgr.git $BASE/luna-sysmgr
    fi
